...
import cn.wltc.biz.weixin.entity.media.WeixinMedia;
import cn.wltc.biz.weixin.entity.message.response.Article;
import cn.wltc.biz.weixin.entity.message.response.Music;
import cn.wltc.biz.weixin.entity.qrcode.WeixinQRCode;
import cn.wltc.biz.weixin.entity.token.WeixinOauth2Token;
import cn.wltc.biz.weixin.entity.user.SNSUserInfo;
import cn.wltc.biz.weixin.entity.user.WeixinGroup;
import cn.wltc.biz.weixin.entity.user.WeixinUserInfo;
import cn.wltc.biz.weixin.entity.user.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static WeixinOauth2Token getOauth2AccessToken( String code) {
		...
		requestUrl = requestUrl.replace("APPID", CommonUtil.APPID);
		requestUrl = requestUrl.replace("SECRET", CommonUtil.APPSECRET);
